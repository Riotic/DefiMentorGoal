function displayPopup2(divContent){
    ...
    a1.addEventListener('click', function(){
        ...
        tabProfile = scrapContact();
        const TimeOutContact = setTimeout(function(){ displayAjoutContact(divContent, tabProfile); },350);
    });
    
    // pour créer l'image
    var candidature1icon = document.createElement("img"); 
    var imgurl3 = chrome.runtime.getURL("icons/person-outline.png");
    ...
    button1.innerHTML = "    Ajouter le contact";
